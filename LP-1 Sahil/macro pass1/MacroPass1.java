...
public class MacroPass1 {
    ...
    static void pass1() throws Exception {
        ...
        input = new BufferedReader(new InputStreamReader(new FileInputStream("input.txt"))); //reading input file

        PrintWriter output = new PrintWriter(new FileOutputStream("output_pass1.txt"), true); //writing into this file
    ...
    static void showAla(int pass) throws Exception {
		PrintWriter out = new PrintWriter(new FileOutputStream("out_ala_pass" + pass + ".txt"), true); //write in this file
