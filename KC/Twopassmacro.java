 ...
 display(ala, alac, 2);
 System.out.println("Note:Alles are displayed here whereas intermediate pass1 output and");
...
//converting char->string->integer & appending it
 output.write(temp);
 output.newLine();
 }
 flag = 1;
